...
void do_rank_00003 (MPI_Comm comm){
    ...
    MPI_Comm COMM_0x561778237660;
    MPI_Comm COMM_0x561777e7ba40;
    MPI_Comm COMM_561777b03230;
    MPI_Comm COMM_0x561777dde700;
    MPI_Comm COMM_0x561778236420;
    MPI_Comm COMM_0x561777b03230;
    MPI_Comm COMM_0x561777ab2a30;
    ...
    int periods[] = {1,1,1};
    int reorder = 0;
    MPI_Comm comm_new = COMM_561777b03230;
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_2.DefineAttribute<int>("boundary", 0x561777ab529c);
    }
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_21.DefineAttribute<int>("boundary", 0x561777ab529c);
    }
    ...
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x561777dde700);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x561777dde700;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 3;
    MPI_Comm_split(COMM_0x561777dde700, color, key, &COMM_0x561777e7ba40);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x561777e7ba40;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 3;
    MPI_Comm_split(COMM_0x561777e7ba40, color, key, &COMM_0x561777dde700);
...
variable_20.SetSelection({{0,0},{0,0}});
    ...
    // emitting mpi function: MPI_Comm_dup
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x561778236420);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x561778236420;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 3;
    MPI_Comm_split(COMM_0x561778236420, color, key, &COMM_0x561778237660);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x561778237660;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 3;
    MPI_Comm_split(COMM_0x561778237660, color, key, &COMM_0x561778236420);
