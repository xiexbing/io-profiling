...
void do_rank_00001 (MPI_Comm comm){
    ...
    MPI_Comm COMM_0x560ee8464a10;
    MPI_Comm COMM_560ee7d3f440;
    MPI_Comm COMM_0x560ee80d9890;
    MPI_Comm COMM_0x560ee7d3f440;
    MPI_Comm COMM_0x560ee803b480;
    MPI_Comm COMM_0x560ee7cec3e0;
    MPI_Comm COMM_0x560ee84965f0;
    ...
    int periods[] = {1,1,1};
    int reorder = 0;
    MPI_Comm comm_new = COMM_560ee7d3f440;
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_2.DefineAttribute<int>("boundary", 0x560ee7ced3dc);
    }
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_21.DefineAttribute<int>("boundary", 0x560ee7ced3dc);
    }
    ...
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x560ee803b480);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x560ee803b480;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 0;
    key = 1;
    MPI_Comm_split(COMM_0x560ee803b480, color, key, &COMM_0x560ee80d9890);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x560ee80d9890;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 1;
    MPI_Comm_split(COMM_0x560ee80d9890, color, key, &COMM_0x560ee803b480);
...
variable_20.SetSelection({{0,0},{0,0}});
    ...
    // emitting mpi function: MPI_Comm_dup
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x560ee8464a10);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x560ee8464a10;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 0;
    key = 1;
    MPI_Comm_split(COMM_0x560ee8464a10, color, key, &COMM_0x560ee84965f0);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x560ee84965f0;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 1;
    MPI_Comm_split(COMM_0x560ee84965f0, color, key, &COMM_0x560ee8464a10);
