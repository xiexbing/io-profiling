...
void do_rank_00002 (MPI_Comm comm){
    ...
    MPI_Comm COMM_55751015e2d0;
    MPI_Comm COMM_0x5575108910e0;
    MPI_Comm COMM_0x5575104d6bf0;
    MPI_Comm COMM_0x557510892870;
    MPI_Comm COMM_0x55751010f260;
    MPI_Comm COMM_0x55751015e2d0;
    MPI_Comm COMM_0x5575104397e0;
    ...
    int periods[] = {1,1,1};
    int reorder = 0;
    MPI_Comm comm_new = COMM_55751015e2d0;
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_2.DefineAttribute<int>("boundary", 0x55751011029c);
    }
    ...
    // emitting adios2 function: adios2::IO::DefineAttribute<int>
    {
    adios2::Attribute<int> attribute_17 = io_21.DefineAttribute<int>("boundary", 0x55751011029c);
    }
    ...
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x5575104397e0);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x5575104397e0;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 2;
    MPI_Comm_split(COMM_0x5575104397e0, color, key, &COMM_0x5575104d6bf0);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x5575104d6bf0;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 0;
    key = 2;
    MPI_Comm_split(COMM_0x5575104d6bf0, color, key, &COMM_0x5575104397e0);
...
variable_20.SetSelection({{0,0},{0,0}});
    ...
    // emitting mpi function: MPI_Comm_dup
    MPI_Comm_dup(MPI_COMM_WORLD, &COMM_0x5575108910e0);

    // emitting mpi function: MPI_Allreduce
    {
    int count = 8;
    MPI_Comm comm = COMM_0x5575108910e0;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 1;
    key = 2;
    MPI_Comm_split(COMM_0x5575108910e0, color, key, &COMM_0x557510892870);
    ...
    {
    int count = 8;
    MPI_Comm comm = COMM_0x557510892870;
    MPI_Datatype datatype = MPI_BYTE;
    MPI_Op op = MPI_SUM;
    MPI_Allreduce(sendbuf, recvbuf, count, datatype, op, comm);
    }
    ...
    color = 0;
    key = 2;
    MPI_Comm_split(COMM_0x557510892870, color, key, &COMM_0x5575108910e0);
